...
Дано Табличный документ "SpreadsheetDocument" равен макету "ПечатнаяФормаРасходТовара" по шаблону



Сценарий:  проверка движения по регистру взаиморасчетов с контрагентами
И Я открыл новый сеанс TestClient или подключил уже существующий
И Я открываю навигационную ссылку "e1cib/data/Документ.РасходТовара?ref=8c5e04421a8dab8111ed7126d4100cec"
...
И таблица "Список" стала равной по шаблону:
	...
	| '01.12.2022 15:47:54' | 'Продажа 000000109 от 01.12.2022 15:47:54' | '1'            | 'Магазин "Продукты"' | '3 000,00'  | 'Bosch15'  | '1,00'       |
	| '01.12.2022 15:47:54' | 'Продажа 000000109 от 01.12.2022 15:47:54' | '2'            | 'Магазин "Продукты"' | '10 000,00' | 'Veko67NE' | '1,00'       |
...
И таблица "Список" стала равной по шаблону:
	...
	| '01.12.2022 15:47:54' | 'Продажа 000000109 от 01.12.2022 15:47:54' | '1'            | 'Большой' | 'Bosch15'  | '1,00'       |
	| '01.12.2022 15:47:54' | 'Продажа 000000109 от 01.12.2022 15:47:54' | '2'            | 'Большой' | 'Veko67NE' | '1,00'       |
